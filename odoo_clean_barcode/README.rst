...
.. |badge3| image:: https://shields.io/badge/Alliantum%2fodoo_clean_barcode-24c3f3?style=for-the-badge&logo=github&label=github
    :target: https://github.com/Alliantum/odoo_clean_barcode/tree/14.0
...
of **all the barcodes that are generated on a pdf**.
   ...
   .. rubric:: We recomend to perform an odoo server restart once the module
      is installed to prevent any problems, this would be more than
      enough 😉
...
`feedback <https://github.com/Alliantum/odoo_clean_barcode/issues/new?body=module:%20odoo_clean_barcode%0Aversion:%2014.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
